...
public class UpdateDrugPersonActivity extends AllenBaseActivity {
    ...
    protected int getLayoutResID() {
        return R.layout.core_xd_person_update_layout;
    }

    @Override
    protected void initBar() {
        entry = (DrugEntity) getIntent().getSerializableExtra(Constants.ObjectFirst);
        setToolbarTitle(toolbar, entry == null ? "添加吸毒人员" : "编辑吸毒人员", true);
    }
    ...
    protected void initUI(@Nullable Bundle savedInstanceState) {
        ...
        if(entry!=null){
            ...
            housePersonName.setText(entry.getB2002());
            housePersonAname.setText(entry.getB2003());
            housePersonIdnumber.setText(entry.getB2001());
            housePersonSex.setText(entry.getB2004Name());
            sex = entry.getB2004();
            housePersonBirthday.setText(entry.getB2005());
            housePersonJg.setText(entry.getB2007());
            housePersonMz.setText(entry.getB2006());
            nation = entry.getB2006();
            housePersonHyzk.setText(entry.getB2008());
            marriage = entry.getB2008();
            housePersonZzmm.setText(entry.getB2009Obj().getCodeName());
            zzmm = entry.getB2009();
            housePersonXl.setText(entry.getB2010Obj().getCodeName());
            edu = entry.getB2010();
            housePersonZjxy.setText(entry.getB2011());
            zongj = entry.getB2011();
            housePersonZylb.setText(entry.getB2012());
            worktype = entry.getB2012();
            housePersonZy.setText(entry.getB2013());
            housePersonFwcs.setText(entry.getB2014());
            housePersonPhone.setText(entry.getB2015());
            housePersonHjd.setText(entry.getB2016Obj().getCodeName());
            hjd = entry.getB2016();
            housePersonHjddz.setText(entry.getB2017());
            housePersonXzd.setText(entry.getB2018Obj().getCodeName());
            xzd = entry.getB2018();
            housePersonXzddz.setText(entry.getB2019());
        }
    }
            ...
            requestRunPermisssion(new String[]{Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE}, 10, new PermissionListener() {
                ...
                public void onGranted(int requestCode) {
                    MultiImageSelector.create().single().showCamera(true)
                            .start(UpdateDrugPersonActivity.this,11);
                }
    ...
    private void commit(){
        ...
        if(entry!=null){
            https.url(CoreApi.update_DrugPerson).put().addParam("B2000",entry.getB2000());
        }else{
            https.url(CoreApi.add_DrugPerson).post();
        }
        https.addParam("B2001",pid).addParam("B2002",name).addParam("B2003",uname).addParam("B2004",sex).addParam("B2005",birthday)
                .addParam("B2006",nation).addParam("B2007",nativeplace).addParam("B2008",marriage).addParam("B2009",zzmm)
                .addParam("B2010",edu).addParam("B2011",zongj).addParam("B2012",worktype).addParam("B2013",work).addParam("B2014",fwcs)
                .addParam("B2015",link).addParam("B2016",hjd).addParam("B2017",hjddetail).addParam("B2018",xzd).addParam("B2019",xzddetail)
