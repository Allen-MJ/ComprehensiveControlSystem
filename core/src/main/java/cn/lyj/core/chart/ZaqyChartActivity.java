...
public class ZaqyChartActivity extends AllenBaseActivity {
    ...
    protected int getLayoutResID() {
        return R.layout.core_zaqy_chart_layout;
    }
