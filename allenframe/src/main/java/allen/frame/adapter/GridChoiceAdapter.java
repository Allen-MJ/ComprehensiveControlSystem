...
public class GridChoiceAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<Grid> list;

    public GridChoiceAdapter(){
        list = new ArrayList<>();
    }
    ...
    class ObjectHolder extends RecyclerView.ViewHolder{
        ...
        public void bind(final Grid grid){
            if(grid!=null){
                name.setText(grid.getGridName());
                view.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        v.setEnabled(false);
                        if(listener!=null){
                            listener.onItemClick(v,getAdapterPosition(),grid);
                        }
                        v.setEnabled(true);
                    }
                });
    ...
    public interface OnItemClickListener{
        void onItemClick(View v, int position, Grid grid);
    }
}
