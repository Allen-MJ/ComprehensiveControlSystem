...
//    		if (isInEditMode()) { return; }
           ...
           if (event.getAction() == MotionEvent.ACTION_UP) { 
               ...
               if (touchable) { 
                   ...
                   if(onClearnListenner!=null){
                	   onClearnListenner.onClearnEvent();
                   }
               } 
           } 
       } 
   ...
   private onClearnListenner onClearnListenner = null;
   public void setOnClearnListenner(onClearnListenner onClearnListenner) {
	   this.onClearnListenner = onClearnListenner;
   }

   public interface onClearnListenner{
