...
public class NotificationUtil {
    ...
    /*public static void showSettingDialog(final Context mContext) {
        ...
        customDialogSureCancel.getContentView().setText(R.string.never_be_pass);
        customDialogSureCancel.getSureView().setText(R.string.i_know);
        customDialogSureCancel.getCancelView().setText(R.string.go_to_set);
