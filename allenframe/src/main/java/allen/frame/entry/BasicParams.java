...
import static allen.frame.entry.FileInfo.FileType.Audio;
import static allen.frame.entry.FileInfo.FileType.Folder;
import static allen.frame.entry.FileInfo.FileType.Image;
import static allen.frame.entry.FileInfo.FileType.Unknown;
import static allen.frame.entry.FileInfo.FileType.Video;
