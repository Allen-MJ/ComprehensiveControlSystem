...
import allen.frame.entry.ResultBean;
...
public class AllenChoiceUnitsActivity extends AllenBaseActivity {
    ...
    private List<Units> list,sublist;
    private String mKey="";
    ...
    protected void initUI(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new UnitsChoiceAdapter();
    ...
    protected void addEvent() {
        ...
        adapter.setOnItemClickListener(new UnitsChoiceAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View v, int position, Units units) {
                setResult(RESULT_OK,getIntent().putExtra(Constants.Key_1,units.getOrgId())
                        .putExtra(Constants.Key_2,units.getOrgName()));
                finish();
            }
        });
    ...
    private void loadData(){
        Https.with(this).url(BaseApi._1).addParam("page",page++).addParam("size",size)
