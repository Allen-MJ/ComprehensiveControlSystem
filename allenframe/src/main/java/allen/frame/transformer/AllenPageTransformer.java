 ...
 * 描述:
 */
public abstract class AllenPageTransformer implements ViewPager.PageTransformer {
    ...
    public static AllenPageTransformer getPageTransformer(TransitionEffect effect) {
        switch (effect) {
            case Default:
