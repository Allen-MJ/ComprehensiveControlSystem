...
public class TestActivity extends AllenBaseActivity {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.into_1:
                startActivity(new Intent(context, cn.lyj.thepublic.LoginActivity.class));
                break;
            case R.id.into_2:
                startActivity(new Intent(context, cn.lyj.work.LoginActivity.class));
                break;
            case R.id.into_3:
                startActivity(new Intent(context, cn.lyj.leader.LoginActivity.class));
                break;
        }
    }
